...
async function startInstance(instance_id) {
    ...
    await ec2.startInstances(params).promise().then((data) => {
        res_data = data;
    }).catch(function (err) {
        res_data = err;
    });
...
async function stopInstance(instance_id) {
    ...
    await ec2.stopInstances(params).promise().then((data) => {
        res_data = data;
    }).catch(function (err) {
        res_data = err;
    });
...
async function rebootInstance(instance_id) {
    ...
    await ec2.rebootInstances(params).promise().then((data) => {
        res_data = data;
    }).catch(function (err) {
        res_data = err;
    });
...
async function describeInstance() {
    ...
    await ec2.describeInstances(params).promise().then((data) => {
        res_data = data;
    }).catch(function (err) {
        res_data = err;
    });
